    ...
    void Update()
    {
        ...
        if (Input.GetMouseButtonDown(1))
        {
            ...
            if (GameObject.Find("Bullet(Clone)") == null)
            {
                ...
                //  距離を計算
                float dis = Vector3.Distance(m_rayHitObject.point, m_shotPosition.transform.position);
                ...
                //  消える時間を設定
                bullet.GetComponent<Bullet>().SetLifeTimer(dis / (bullet.GetComponent<Bullet>().m_speed * 60.0f));
